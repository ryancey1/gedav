...
```{r step4}
step4 <- matrix(three, nrow = length(three), ncol = 4, byrow = FALSE)
```
...
```{r step5}
step5 <- apply(one, 2, rank, ties.method = "first")
```
